INSERT INTO "SELECT au.nome, au.codautor, au.nascimento, count(liv.autor) as quantidade
FROM autor as au
left join livro as liv
on liv.autor = au.codautor 
group by au.codautor
order by au.nome " (nome,codautor,nascimento,quantidade) VALUES
